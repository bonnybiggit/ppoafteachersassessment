        ...
        <div className="bg-white py-8 px-6 shadow-sm border border-[#ede8e1] rounded-xl sm:px-10">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-semibold text-white bg-[#0c3b6e] hover:bg-[#082a50] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0c3b6e] transition-colors"
              >
                Sign In
              </button>
            </div>
          ...
          <div className="mt-6 text-center text-xs text-gray-500">
            <span className="bg-[#faf8f5] px-2 py-1 rounded text-gray-600 border border-[#ede8e1]">
              UI Only — Authentication will be connected in a future step.
            </span>
          </div>
